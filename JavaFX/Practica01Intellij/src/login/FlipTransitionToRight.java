 ...
 */
public class FlipTransitionToRight {
    private static final double DURATION = 1_000;
    private double width;
    private double height;

    public FlipTransitionToRight(double width, double height) {
        this.width = width;
        this.height = height;
    }
    ...
    public void play(Group group) {
        ...
        flipRect.setFill(Paint.valueOf(Constantes.COLOR_TAPA_CARPETA_POR_DETRAS));
        ...
        // ??????????
        Rectangle shadow = new Rectangle( 30, 0, 60, height);
        ...
        animation.setOnFinished(e -> {
            present.setLayoutX(flip.getLayoutX());
            ...
            //group.setLayoutX(group.getLayoutX()-width);
