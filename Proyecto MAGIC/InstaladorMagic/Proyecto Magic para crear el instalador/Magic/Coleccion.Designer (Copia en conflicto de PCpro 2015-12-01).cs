namespace Magic
{
    partial class Coleccion
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lvMiColeccion.ItemDrag += new System.Windows.Forms.ItemDragEventHandler(this.itemDragCarta);
            this.lvMiColeccion.DragDrop += new System.Windows.Forms.DragEventHandler(this.dragoDrop);
            this.lvMiColeccion.DragEnter += new System.Windows.Forms.DragEventHandler(this.listViewDragEnter);
            this.lvMiColeccion.MouseClick += new System.Windows.Forms.MouseEventHandler(this.clickDerechoEnItem);
            this.lvMiColeccion.MouseDown += new System.Windows.Forms.MouseEventHandler(this.llevarseImagen);
            ...
            this.lvTienda.ItemDrag += new System.Windows.Forms.ItemDragEventHandler(this.itemDragCarta);
            this.lvTienda.DragDrop += new System.Windows.Forms.DragEventHandler(this.dragoDrop);
            this.lvTienda.DragEnter += new System.Windows.Forms.DragEventHandler(this.listViewDragEnter);
            ...
            // pbCartaMoviendose
            // 
            this.pbCartaMoviendose.BackColor = System.Drawing.Color.Transparent;
            this.pbCartaMoviendose.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
            this.pbCartaMoviendose.Location = new System.Drawing.Point(40, -80);
            this.pbCartaMoviendose.Margin = new System.Windows.Forms.Padding(0);
            ...
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.moverCartaConRaton);
