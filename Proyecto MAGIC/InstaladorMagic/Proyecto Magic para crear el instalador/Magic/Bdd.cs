...
namespace Magic
{
    public static class Bdd
    {
        ...
        private readonly static string BASE_DATA = "Data Source = (LocalDB)\\MSSQLLocalDB;AttachDbFilename="+ Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\BDD\\Magic.mdf;Integrated Security = True; Connect Timeout = 30;ApplicationIntent=ReadWrite";
