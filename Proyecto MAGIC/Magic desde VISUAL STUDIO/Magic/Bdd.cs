...
namespace Magic
{
    public static class Bdd
    {
        ...
        private readonly static string BASE_DATA = "Data Source = (LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\Magic.mdf;Integrated Security = True; Connect Timeout = 30";
